          ...
          markdown: {
            ...
            shikiConfig: {
              ...
              transformers: [
                ...
                transformerNotationHighlight(),
                transformerRemoveNotationEscape(),
                // Custom transformers - Type assertion to resolve version conflicts
                updateStyle() as import('@shikijs/types').ShikiTransformer,
                addTitle() as import('@shikijs/types').ShikiTransformer,
                addLanguage() as import('@shikijs/types').ShikiTransformer,
                addCopyButton(2000) as import('@shikijs/types').ShikiTransformer, // timeout in ms
                addCollapse(15) as import('@shikijs/types').ShikiTransformer // max lines that needs to collapse
              ]
            }
          },
