...
The domain name of the HanQiu Does is `hqsay.com`. Except for the relevant subdomain name, unless it is certified by HanQiu Does, information in my name, owned by others, and stolen by others has nothing to do with me.
...
All works in HanQiu Does is under [Attribution-NonCommercial-ShareAlike 4.0 International (CC BY-NC-SA 4.0)](https://creativecommons.org/licenses/by-nc-sa/4.0/).
...
Source Code: [GPL 3.0 License](https://github.com/Tonybug777/hqsay/blob/main/LICENSE)
